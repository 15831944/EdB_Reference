...
namespace EdBDemo_CSharp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string queryData = Marshal.PtrToStringAnsi(EdBApi.EdB_QueryData("280079160", clientID, 2014));
            ...
            string getPrice = Marshal.PtrToStringAnsi(EdBApi.EdB_GetPrice(clientID, "70000"));

...
namespace EdBApi_CSharp
{
    public class EdBApi
    {
        ...
        public static extern string EdB_QueryData(string User, Int32 ClientID, Int32 Category);

        [DllImport("EdBApi.dll", EntryPoint = "EdB_SendOrder", CallingConvention = CallingConvention.Cdecl)]
        public static extern string EdB_SendOrder(string ClientID, Int32 Fx, string User, string Gddm, string Gpdm, Int32 Quantity, float Price);

        [DllImport("EdBApi.dll", EntryPoint = "EdB_GetPrice", CallingConvention = CallingConvention.Cdecl)]
        public static extern string EdB_GetPrice(Int32 ClientID, string Gpdm);

        [DllImport("EdBApi.dll", EntryPoint = "EdB_CancelOrder", CallingConvention = CallingConvention.Cdecl)]
        public static extern string EdB_CancelOrder(Int32 ClientID, string User, string Bho, Int32 jYs);
    }
}
